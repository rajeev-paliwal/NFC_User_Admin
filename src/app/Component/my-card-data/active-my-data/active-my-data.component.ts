...
@Component({
  selector: 'app-active-my-data',
  templateUrl: './active-my-data.component.html',
  styleUrls: ['./active-my-data.component.css']
})
export class ActiveMyDataComponent implements OnInit {
  ...
  activePost(Data: any ) {
   ...
   this.UniqueID = Data.ele.UniqId;
    this.crd_services.ActivedCardData(this.CardHolderId , this.UniqueID).subscribe((res: any) =>{
      this.event.emit('OK');
